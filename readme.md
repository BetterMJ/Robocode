...
Am 26.11.2021 habe ich ein Portfolio gemacht, wo ich als Verbesserungsvorschlag hatte, mich weniger mit Design zu befassen und mehr mit dem programmieren und erst zum Schluss sich um das Design kümmern. In diesem Falle habe ich den Verbesserungsvorschlag nicht erfüllt, da ich direkt am Anfang mich mit dem Design des Roboters befasst habe, statt mit den Funktionen, jedoch hat es bei Robocode nicht zu viel zu Designen und hatte zum Glück nicht zu viel Zeit verloren, jedoch habe ich mich trotzdem stundenlang damit befasst.
